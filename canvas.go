...
func (c *JsCanvas) DrawPolyLine(start Point, points []Point, fill bool) {
...
func (c *JsCanvas) DrawImageF(img js.Value, sX, sY, sW, sH, dX, dY, dW, dH float64) {
	c.Context.Call("drawImage", img, sX, sY, sW, sH, dX, dY, dW, dH)
}

func (c *JsCanvas) Save() {
	c.Context.Call("save")
}

func (c *JsCanvas) Restore() {
	c.Context.Call("restore")
}

func (c *JsCanvas) OffSetLeft() int {
	return c.Canvas.Get("offsetLeft").Int()
}

func (c *JsCanvas) OffSetTop() int {
	return c.Canvas.Get("offsetTop").Int()
}
